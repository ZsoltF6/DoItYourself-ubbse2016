...
public class DifferentialEvolution {
    ...
    static double mutationConstant = 0.5;//f
    static double crossoverRate = 0.9;//cr
    static int maxFunctionCalls = 1000 * dimensionality;
    static int runs = 50; //hanyszor fut le
    ...
    static List<Double> individuals = new ArrayList<Double>();
    static  List<List<Double>> ujPopulation = new ArrayList<List<Double>>();
    /**
    ...
    public static void generateAndTestLoop(int function) {
        ...
        case 1:
            //Sphere
            initialPopulation.addAll(generatePopulation(-5.0, 5.0));
            break;
        case 2:
            //axis
        ...
        for (int r = 0; r < runs; r++) {
            ...
            while (currentFunctionCalls < maxFunctionCalls) {
                for (int i = 0; i < populationSize; i++) {
                    ...
                    ujPopulation = initialPopulation;
                }
    ...
    public static List<List<Double>> getIndividuals() {
        return ujPopulation;    
    }
}
